...
################################################################################
## Form generated from reading UI file 'AddEditWindow_personal.ui'
##
...
"border: 1px solid red;")
        ...
        self.add_edit_button.setGeometry(QRect(300, 360, 85, 30))
...
"border: 1px solid red;")
    ...
    def retranslateUi(self, AddEditWindow):
        ...
        self.title_label.setText(QCoreApplication.translate("AddEditWindow", u"DATOS PERSONAL", None))
        ...
        self.label_3.setText(QCoreApplication.translate("AddEditWindow", u"NOMBRE COMPLETO", None))
        self.label_4.setText(QCoreApplication.translate("AddEditWindow", u"TELEFONO", None))
        self.label_5.setText(QCoreApplication.translate("AddEditWindow", u"FECHA DE NACIMIENTO", None))
        self.label_6.setText(QCoreApplication.translate("AddEditWindow", u"DIRECCION", None))
        self.label_7.setText(QCoreApplication.translate("AddEditWindow", u"FOTOGRAFIA DEL PERSONAL", None))
        ...
        self.label_8.setText(QCoreApplication.translate("AddEditWindow", u"CARGO", None))
        self.label_9.setText(QCoreApplication.translate("AddEditWindow", u"ESPECIALIDAD", None))
    # retranslateUi
