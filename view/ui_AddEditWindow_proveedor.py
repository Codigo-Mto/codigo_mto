...
################################################################################
## Form generated from reading UI file 'AddEditWindow_proveedor.ui'
##
...
"")
        ...
        self.label.setGeometry(QRect(70, 50, 111, 16))
        self.lineEdit = QLineEdit(self.content_frame)
        self.lineEdit.setObjectName(u"lineEdit")
        self.lineEdit.setGeometry(QRect(70, 70, 200, 30))
        self.lineEdit.setStyleSheet(u"background-color: rgb(255, 255, 255);\n"
"border: 1px solid red;")
        self.label_3 = QLabel(self.content_frame)
        self.label_3.setObjectName(u"label_3")
        self.label_3.setGeometry(QRect(70, 120, 191, 16))
        self.lineEdit_3 = QLineEdit(self.content_frame)
        self.lineEdit_3.setObjectName(u"lineEdit_3")
        self.lineEdit_3.setGeometry(QRect(70, 140, 200, 30))
        self.lineEdit_3.setStyleSheet(u"background-color: rgb(255, 255, 255);\n"
"border: 1px solid red;")
        self.label_4 = QLabel(self.content_frame)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setGeometry(QRect(70, 190, 71, 16))
        self.lineEdit_4 = QLineEdit(self.content_frame)
        self.lineEdit_4.setObjectName(u"lineEdit_4")
        self.lineEdit_4.setGeometry(QRect(70, 210, 200, 30))
        self.lineEdit_4.setStyleSheet(u"background-color: rgb(255, 255, 255);\n"
"border: 1px solid red;")
        self.label_5 = QLabel(self.content_frame)
        self.label_5.setObjectName(u"label_5")
        self.label_5.setGeometry(QRect(70, 260, 161, 16))
        self.lineEdit_5 = QLineEdit(self.content_frame)
        self.lineEdit_5.setObjectName(u"lineEdit_5")
        self.lineEdit_5.setGeometry(QRect(70, 280, 200, 30))
...
"border: 1px solid red;")
        ...
        self.add_edit_button.setGeometry(QRect(290, 360, 85, 30))
...
"QPushButton::hover{background-color:#ffc13b}")
        ...
        self.label_8.setGeometry(QRect(420, 190, 161, 16))
        self.lineEdit_8 = QLineEdit(self.content_frame)
        self.lineEdit_8.setObjectName(u"lineEdit_8")
        self.lineEdit_8.setGeometry(QRect(420, 210, 200, 30))
...
"border: 1px solid red;")
    ...
    def retranslateUi(self, AddEditWindow):
        ...
        self.title_label.setText(QCoreApplication.translate("AddEditWindow", u"DATOS DEL PROVEEDOR", None))
        ...
        self.label.setText(QCoreApplication.translate("AddEditWindow", u"EMPRESA", None))
        self.label_3.setText(QCoreApplication.translate("AddEditWindow", u"PERSONA DE CONTACTO", None))
        self.label_4.setText(QCoreApplication.translate("AddEditWindow", u"DIRECCION", None))
        self.label_5.setText(QCoreApplication.translate("AddEditWindow", u"CORREO ELECTRONICO", None))
        self.label_6.setText(QCoreApplication.translate("AddEditWindow", u"TELEFONO", None))
        self.label_7.setText(QCoreApplication.translate("AddEditWindow", u"PAGINA WEB", None))
        self.add_edit_button.setText(QCoreApplication.translate("AddEditWindow", u"text", None))
        self.label_8.setText(QCoreApplication.translate("AddEditWindow", u"TIPO PROVEEDOR", None))
    # retranslateUi
