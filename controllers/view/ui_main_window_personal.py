...
################################################################################
## Form generated from reading UI file 'main_window_personal.ui'
##
...
"border-radius: 0px;")
    ...
    def retranslateUi(self, MainWidget):
        ...
        self.title_label.setText(QCoreApplication.translate("MainWidget", u"PERSONAL MANTENIMIENTO", None))
        ...
        self.new_recipe_button.setText(QCoreApplication.translate("MainWidget", u"A\u00f1adir Personal", None))
        self.label.setText("")
        self.serch_line_edit.setText(QCoreApplication.translate("MainWidget", u"Buscar Personal", None))
        self.serch_line_edit.setPlaceholderText(QCoreApplication.translate("MainWidget", u"Buscar Maquina", None))
    # retranslateUi
