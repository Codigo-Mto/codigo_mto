...
################################################################################
## Form generated from reading UI file 'main_window_proveedor.ui'
##
...
"")
        ...
        font2.setBold(True)
        self.new_recipe_button.setFont(font2)
...
"border-radius: 0px;")
    ...
    def retranslateUi(self, MainWidget):
        ...
        self.title_label.setText(QCoreApplication.translate("MainWidget", u"SISTEMA MANTENIMIENTO", None))
        ...
        self.new_recipe_button.setText(QCoreApplication.translate("MainWidget", u"Nuevo Proveedor", None))
        self.label.setText("")
        self.serch_line_edit.setPlaceholderText(QCoreApplication.translate("MainWidget", u"Buscar Proveedor", None))
